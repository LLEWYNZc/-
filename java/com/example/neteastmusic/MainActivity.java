...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toLocalMusic.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (ContextCompat.checkSelfPermission(MainActivity.this,
                    ...
                    Intent toLocalMusic = new Intent(MainActivity.this, local_list.class);
        ...
        //Set onClickListener on favorite_list
        ...
        toFavoriteMusic.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent toFavoriteMusic = new Intent(MainActivity.this, Music_playing.class);
    ...
    private void requestStoragePermission() {
        if (ActivityCompat.shouldShowRequestPermissionRationale(this,
            ...
            new AlertDialog.Builder(this)
                    ...
                    .setMessage("This permission is needed ro access local files")
